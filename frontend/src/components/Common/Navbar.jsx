                ...
                <div className="container mx-auto flex items-center justify-between px-12 py-3">
                    ...
                    <div className="flex items-center gap-4 cursor-pointer">
                        ...
                        <button
                            ...
                            {cartItemCount > 0 && (
                                <span className="absolute bg-red-600 text-white text-xs rounded-full px-2 -top-1.5 ">
                                    {cartItemCount}
                                </span>
                            )}
                        </button>
            ...
            <div className={`fixed top-0 left-0 w-3/4 sm-1/2 md:1/3 h-full bg-white shadow-lg transform transition-transform duration-300 z-50 ${navDrawerOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                ...
                <div className="p-4">
                    ...
                    <nav className="space-y-2">
                        ...
                        <Link to='/collections/all?gender=Top Wear' onClick={toggleNavDrawer} className="block text-gray-600 hover:text-black">
                            Top Wear
                        </Link>
                        <Link to='/collections/all?gender=Bottom Wear' onClick={toggleNavDrawer} className="block text-gray-600 hover:text-black">
                            Bottom Wear
                        </Link>
                    </nav>
                </div>
